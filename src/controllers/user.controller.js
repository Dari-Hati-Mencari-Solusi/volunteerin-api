...
const REVIEW_MESSAGES = {
  ...
  [REVIEW_RESULTS.REJECTED_LEGALITY]:
    'Berhasil menolak legalitas akun partner!',
};

const EMAIL_SUBJECTS = {
  [REVIEW_RESULTS.ACCEPTED_PROFILE]: 'Akun Partner Anda Telah Disetujui!',
  [REVIEW_RESULTS.ACCEPTED_LEGALITY]:
    'Legalitas Akun Partner Anda Telah Disetujui!',
  [REVIEW_RESULTS.REJECTED_PROFILE]: 'Maaf, Akun Anda Belum Disetujui',
  [REVIEW_RESULTS.REJECTED_LEGALITY]:
    'Maaf, Legalitas Akun Anda Belum Disetujui',
};
const EMAIL_MESSAGES = {
  [REVIEW_RESULTS.ACCEPTED_PROFILE]:
    'Selamat! Akun Partner Anda di Volunteerin telah berhasil disetujui oleh tim kami.',
  [REVIEW_RESULTS.ACCEPTED_LEGALITY]:
    'Selamat! Legalitas Akun Partner Anda di Volunteerin telah berhasil disetujui oleh tim kami.',
};
...
export const reviewPartnerUser = async (req, res, next) => {
  try {
    ...
    const emailData = {
      name: user.name,
      dashboardPartnerUrl,
      title: EMAIL_SUBJECTS[reviewResult], // subject ya si title juga
    ...
    const mailData = {
      ...
      subject: EMAIL_SUBJECTS[reviewResult],
